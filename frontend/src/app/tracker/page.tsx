    ...
    return (
        <section className="flex min-h-0 flex-1 flex-col bg-[var(--term-panel)]">
            <div className="flex h-11 shrink-0 items-center border-b border-[var(--term-border)] px-4">
                ...
                {area === 'kols' && <label className="ml-4 flex h-7 w-[min(22rem,45vw)] items-center rounded-full border border-[var(--term-border)] bg-[var(--term-raised)] px-3"><MagnifyingGlassIcon className="h-3.5 w-3.5 text-[var(--term-dim)]" /><input className="min-w-0 flex-1 bg-transparent pl-2 text-[10px] text-white outline-none" placeholder="Search handle or name" /></label>}
