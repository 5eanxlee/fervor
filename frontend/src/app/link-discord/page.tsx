...
export default function LinkDiscordPage() {
    return <Suspense fallback={<main data-terminal-theme="terminal" className="grid h-full place-items-center bg-[var(--term-bg)]"><div className="spinner" /></main>}><LinkDiscordContent /></Suspense>;
}
