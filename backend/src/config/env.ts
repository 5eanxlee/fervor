...
const EnvSchema = z.object({
    ...
    RT_HEARTBEAT_MS: z.coerce.number().int().min(1_000).max(60_000).default(15_000),
    RT_POLL_MS: z.coerce.number().int().min(5).max(5_000).default(20),
    RT_QUEUE_BYTES: z.coerce.number().int().min(16_384).max(16_777_216).default(1_048_576),
    RT_QUEUE_FRAMES: z.coerce.number().int().min(16).max(16_384).default(512),
    RT_MAX_SUBS: z.coerce.number().int().min(1).max(256).default(32),
    RT_RESUME_EVENTS: z.coerce.number().int().min(500).max(1_000_000).default(20_000),
    RT_MAX_PAYLOAD_BYTES: z.coerce.number().int().min(1_024).max(65_536).default(16_384),
